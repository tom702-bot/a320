...
The 5 September 2026 FCOM audit reviewed all 259 limitation questions, 315 systems questions, eight memory cards and 141 fill-in cells. The 6 September follow-up rechecked all 102 outstanding records and restored four corrected or qualified questions. Grading now includes 200 limitations, 296 systems questions across 18 subjects, and 121 fill-in cells. Of the remaining 98 exclusions, 84 keys match the supplied manual but need Ansett applicability confirmation; 14 have source conflicts or missing descriptions. See [the outstanding-item review](OUTSTANDING_REVIEW.md) and the per-item follow-up in verification-audit.json. Source matching is not operational certification or confirmation of the latest revision.
