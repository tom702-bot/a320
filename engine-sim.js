(function(){
  ...
  const systems={
    ...
    oil:{
      ...
      nodes:[
        node('tank',35,215,125,100,'OIL TANK',component('OIL TANK','Stores the engine-oil supply and receives scavenged oil.','Oil quantity is transmitted for ECAM indication; the tank feeds the supply pump.','Before start, minimum quantity is 9.5 qt plus estimated flight consumption; average consumption is 0.5 qt/h.','DSC-70-50; LIM-ENG')),
        ...
        node('ecam',765,55,110,75,'ECAM',component('OIL INDICATIONS','Displays oil pressure, low-pressure warning, temperature, quantity and filter-clog status.','Values and warnings allow crew monitoring throughout start and operation.','Maximum oil temperature is 140°C continuous or 155°C for 15 minutes.','DSC-70-50; LIM-ENG'))
      ],
      edges:[
      ...
      modes:[
        ...
        mode('hightemp','HIGH TEMPERATURE','fault','HIGH OIL TEMPERATURE','Cooling is insufficient or heat load is excessive, so oil temperature has entered a limit region.',[
          'Maximum continuous: 140°C.','Maximum transient: 155°C for 15 minutes.','Minimum before takeoff: −10°C.'
        ...
        mode('cold','COLD OIL','caution','OIL TEMPERATURE — COLD LIMITS','Oil must be warm enough for the demanded engine condition.',[
          'Minimum for start: −40°C.','Minimum before takeoff: −10°C.'
