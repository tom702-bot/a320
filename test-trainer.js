...
async function offlineTests(){
  ...
  assert.match(await flows.text(),/flow-sim\.js\?v=47/);
  ...
  assert.equal(await (await caches.open('a320-trainer-v47')).match('missing.js'),undefined,'404 responses are not cached');
