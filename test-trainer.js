...
async function offlineTests(){
  ...
  assert.match(await flows.text(),/flow-sim\.js\?v=46/);
  ...
  assert.equal(await (await caches.open('a320-trainer-v46')).match('missing.js'),undefined,'404 responses are not cached');
